...
Public Class frmNominaFinalE
    ...
    Private Sub cargarColumnas()
        ...
        lsvLista.Columns.Add("TIEMPO_EXTRA_FIJO")
        ...
        lsvLista.Columns.Add("SUELDO_BASE_MENSUAL")
        ...
        lsvLista.Columns.Add("DIFERENCIA_BIMESTRE_ANTERIOR_INFONAVIT")
        ...
        Try
            ...
            If rwFilas Is Nothing = False Then
                For Each Fila In rwFilas
                    ...
                    item.SubItems.Add("" & Fila.Item("TIEMPO_EXTRA_FIJO"))
                    ...
                    item.SubItems.Add("" & Fila.Item("SUELDO_BASE_MENSUAL"))
                    ...
                    item.SubItems.Add("" & Fila.Item("DIFERENCIA_BIMESTRE_ANTERIOR_INFONAVIT"))
                    ...
                    item.SubItems.Add("" & Fila.Item("CUOTA_SINDICAL"))
                    item.SubItems.Add("" & Fila.Item("NETO_A_DISPERSAR"))
        ...
        Try
            ...
            If resultado = DialogResult.Yes Then
                ...
                If lsvLista.CheckedItems.Count > 0 Then
                    ...
                    SQL2 &= " ORDER BY fKiIdPeriodo, iSerie"
                        ...
                        If rwFilas Is Nothing = False Then
                            If rwFilas.Length = 1 Then
                                ...
                                For Each Fila In rwFilas
                                    ...
                                    SQL &= "," & IIf(producto.SubItems(32).Text = "", 0, producto.SubItems(32).Text)
                                    SQL &= "," & IIf(producto.SubItems(33).Text = "", 0, producto.SubItems(33).Text)
                                    SQL &= "," & IIf(producto.SubItems(34).Text = "", 0, producto.SubItems(34).Text)
                                    SQL &= "," & IIf(producto.SubItems(35).Text = "", 0, producto.SubItems(35).Text)
                                    ...
                                    SQL &= ",0"
                                    SQL &= "," & IIf(chkbTodasSeries.Checked, producto.SubItems(54).Text, cboserie.SelectedIndex)
    ...
    Private Sub tsAcumulados_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsAcumulados.Click
        Try
            ...
            SQL = "EXEC getAcumuladosMaeccoFinal " & cboperiodo.SelectedValue
